...
exports.execute = async function (rawCommand, args) {
    ...
    switch (command) {
        ...
        case `waitForAbsent`:
            return wait_1.waitForAbsent(this, args[0]);
        case `waitFor`:
            return wait_1.waitFor(this, args[0]);
        case `scroll`:
...
const enterText = async (self, text) => await observatory_1.executeSocketCommand(self.socket, { command: `enter_text`, text });

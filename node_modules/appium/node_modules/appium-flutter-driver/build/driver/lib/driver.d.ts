...
declare class FlutterDriver extends BaseDriver {
    desiredCapConstraints: IDesiredCapConstraints;
    socket: any;
    ...
    getCurrentContext: (this: FlutterDriver) => string;
    setContext: (this: FlutterDriver, context: string) => string;
    protected currentContext: string;
    private driverShouldDoProxyCmd;
    constructor(opts: any, shouldValidateCaps: boolean);
    createSession(caps: IDesiredCapConstraints): Promise<any[]>;
    deleteSession(): Promise<void>;
    validateLocatorStrategy(strategy: string): any;
    validateDesiredCaps(caps: IDesiredCapConstraints): any;
